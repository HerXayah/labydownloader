...
await downloadFile(downloadString, labyDownloadPath.toString() + "LabyMod-4.jar", s);
        ...
        if (checkIfFileExists(assetFilePath)) {
            ...
            fs.readFile(assetFilePath, function(err, data) {
                ...
                if (hash === checksum) {
                    ...
                    downloadAssets(releaseChannel, labyMCVersions.commitReference, asset, checksum, s, assetFilePath);
                }
            });
        } else {
